      ...
      <div className='mx-auto basis-11/12 lg:basis-10/12'>
        <div className='bg-white rounded-lg p-5 pb-0'>
          <div className='text-center flex flex-wrap justify-between'>
            ...
            <h3 className="my-5 basis-full text-center">{userName !== "" && <> <span className='text-indigo-500 font-bold'>{userName}님, </span><span>문제 유형은 기본값으로 설정되어있으며, 총 {QuizLength} 문제 중 한 문제를 선택하셨습니다.</span></>}</h3>
          </div>
        </div>
